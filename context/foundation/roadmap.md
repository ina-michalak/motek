...
| S-04 | filter-and-sort-yarn-library  | filtrować i sortować listę włóczek                                     | S-01                | FR-004                        | in-progress |
...
- **S-03: edytować zapisaną włóczkę (w tym oznaczyć jako wyczerpaną) lub usunąć** — Archived 2026-08-31 → `context/archive/2026-08-29-manage-saved-yarn-entry/`. Lesson: —.
