...
- TBD — patrz §3 Faza 1. Brak jeszcze ustalonego wzorca w tym repo (dziś zero testów integracyjnych); pierwsza faza wdrożenia ustali konwencję (lokalny Supabase, prawdziwa sesja testowa, bez mockowania Supabase).
