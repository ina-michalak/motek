...
- **Follow-up (2026-09-12)**: Wszystkie 7 ustaleń zaakceptowane i zaimplementowane (F1/F2 zastane już naprawione w working tree, F3–F7 dopisane) — testy 19/19, typecheck i lint czyste. Zobacz „Decyzja" przy każdym ustaleniu.
